...
[staff_loop]
	<div class="well">
		<div class="row-fluid">
			<div class="span3">	
				<a href="[staff-name-slug]">[staff-photo]</a>
			</div>
		<div class="span7">
			<div class="staff-member-info-wrap">
				<a href="[staff-name-slug]">[staff-name-formatted]</a>
				[staff-position-formatted]
				[staff-bio-formatted]
				[staff-email-link]
				<div>[staff-office]</div>
				<div>[staff-phone]</div>
				[staff-mu-custom]
			</div>
		</div>
...
';
	...
	$default_tags = array('[staff-name]', '[staff-name-slug]', '[staff-photo-url]', '[staff-position]', '[staff-email]', '[staff-phone]', '[staff-bio]', '[staff-office]', '[staff-facebook]', '[staff-twitter]');
	$default_tag_string = implode(", ", $default_tags);
	
	$default_formatted_tags = array('[staff-name-formatted]', '[staff-position-formatted]', '[staff-photo]', '[staff-email-link]', '[staff-bio-formatted]', '[staff-mu-custom]');
